...
class SubmitConfig(util.EasyDict):
    """Strongly typed config dict which needed to submit runs.
...
def _create_run_dir_local(submit_config: SubmitConfig) -> str:
    ...
    # 00010-pgan-jellyfish-preset-v2-4gpus-fp32
...
# submit_config和run_func_name这两个参数必须要有，关键字参数**run_func_kwargs可有可无，无返回
